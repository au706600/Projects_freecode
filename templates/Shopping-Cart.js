  ...
  ({ name, id, price, category }) => {
    dessertCards.innerHTML += `
      <div class="dessert-card">
        <h2>${name}</h2>
        <p class="dessert-price">${price} kr</p>
...
class ShoppingCart {
  ...
  calculateTotal() {
    ...
    cartSubTotal.textContent = `${subTotal.toFixed(2)} kr`;
    cartTaxes.textContent = `${tax.toFixed(2)} kr`;
    cartTotal.textContent = `${this.total.toFixed(2)} kr`;
    return this.total;
  }
};
